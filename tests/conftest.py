...
- SQLAlchemy test database (SQLite in-memory for unit tests)
- Authenticated test client
- Pre-created test data (users, customers, products)
"""
...
os.environ['OWNER_PASSWORD'] = 'TestOwner@1234567890123456!'
os.environ['DATABASE_URL'] = 'sqlite:///:memory:'
os.environ['DEBUG'] = 'true'
os.environ['WTF_CSRF_ENABLED'] = 'false'
os.environ['REDIS_URL'] = 'redis://localhost:6379/15'  # Use Redis DB 15 for tests    os.environ['CACHE_TYPE'] = 'simple'    os.environ['RATELIMIT_ENABLED'] = 'false'
...
def app():
    ...
    # Override DATABASE_URL before app creation so config.py picks it up
    os.environ['DATABASE_URL'] = 'sqlite:///:memory:'
    app = create_app()
...
def seller_user(db, owner_user):
    ...
    # Create seller role (owner_user fixture ensures permissions exist)
    seller_perms = [
