...
class Config:
    ...
    TENANT_STRICT = _bool(os.environ.get("TENANT_STRICT"), True)
    ...
    COMPANY_PHONE = os.environ.get("COMPANY_PHONE", "00970598953362")
    COMPANY_PHONE_2 = os.environ.get("COMPANY_PHONE_2", "00970562150193")
    COMPANY_EMAIL = os.environ.get("COMPANY_EMAIL", "")
    COMPANY_WEBSITE = os.environ.get("COMPANY_WEBSITE", "https://azadsystems.com")
    COMPANY_WHATSAPP = os.environ.get("COMPANY_WHATSAPP", "972562150193")
