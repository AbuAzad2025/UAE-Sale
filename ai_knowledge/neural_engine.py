...
class AzadNeuralEngine:
    ...
    def _train_sales_internal(self):
        ...
        _ = {sale.sale_date: sale for sale in daily_sales}
    ...
    def _optimize_stock_internal(self, product_id):
        ...
        if product_data.current_stock < optimal_reorder:
            recommendation = "🔴 اطلب الآن! المخزون أقل من نقطة إعادة الطلب"
            urgency = 'high'
        elif product_data.current_stock < optimal_reorder * 1.5:
            recommendation = "🟡 خطط للطلب قريباً"
            urgency = 'medium'
        else:
            recommendation = "🟢 المخزون كافٍ"
            urgency = 'low'
