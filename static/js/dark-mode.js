...
class DarkMode {
    ...
    addToggleButton() {
        ...
        toggle.innerHTML = `
            <a class="nav-link" href="#" id="dark-mode-toggle" title="تبديل الوضع الداكن">
    ...
    injectStyles() {
        ...
        style.textContent = `
            ...
            .dark-mode .card-header {
                background: linear-gradient(135deg, #2d3561 0%, #1f2841 100%);
    ...
    toggle() {
        if (this.isDark) {
            this.disable();
            notify.info('تم تفعيل الوضع النهاري');
        } else {
            this.enable();
            notify.info('تم تفعيل الوضع الداكن');
        }
    }
}
