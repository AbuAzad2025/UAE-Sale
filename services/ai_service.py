...
class AIService:
    ...
    def is_sensitive_request(message, current_user):
        ...
        """
        import re  # noqa: F811  (local import intentional)
    ...
    @staticmethod
    def _perform_analysis(customer):  # noqa: C901
...
⚠️ مهم: إذا سأل عن بيانات - استخدم الأرقام الموجودة.""".format(
    ...
    def _execute_ai_action(groq_response, user_id):
        ...
        try:
            import json  # noqa: F811  (local import intentional)
            import re  # noqa: F811  (local import intentional)
...
مثال: فاتورة لعميل أحمد: فلتر زيت x2، كاش"""
    ...
    def _gather_relevant_knowledge(message, local_result):
        ...
        try:
            from models import Sale, Customer, Product, User, Payment, Expense, Purchase, Supplier, Cheque
            from extensions import db
